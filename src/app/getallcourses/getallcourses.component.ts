...
export class GetallcoursesComponent implements OnInit {
  ...
  getAllCourses(){
    ...
    getOneProgress(){
      this.courseService.postProgress(this.courseList[this.j].userId,this.courseList[this.j].courseId,this.progressArray[this.j].completedHours).subscribe((data)=>{this.progressArray[this.j]=data})
